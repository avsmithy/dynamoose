                ...
                "functions": (typeSettings) => ({
                    ...
                    "isOfType": (val, type) => {
                        ...
                        if (rangeKey) {
                            ...
                            return utils.dynamoose.getValueTypeCheckResult(model.getInternalProperties(internalProperties).schemas[0], (_a = val[hashKey]) !== null && _a !== void 0 ? _a : val, hashKey, { type }, {}).isValidType;
                        }
                    }
                })
            } })
...
Schema.prototype.getAttributeTypeDetails = function (key, settings = {}) {
    ...
    const getType = (typeVal) => {
        ...
        const isAnyType = typeVal === Internal.Public.any;
